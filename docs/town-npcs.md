...
当前花名册以 **三块农田的 11 个农业 NPC** 为基础，并补了教堂、矿场、守卫、王室采办、**小麦 → 面粉 → 家庭做饭 / 少量面包** 链路、畜牧/酒馆/盐场，以及 **铁矿石 → 铁铲** 链路上的铁矿、炭窑、伐木场、杂货店和铁匠铺 NPC。南侧现在拆成两个并列地点：`saint_bell_chapel` 是 **圣钟教堂**，`saint_bell_garden` 是 **圣钟菜园**。
...
| `saint_bell_garden` | 圣钟菜园 | 2 | 圣钟教堂旁边的两块田地，主要种菜和草药 |
...
| `saint_bell_chapel` | 圣钟教堂 | 3 | 郊区教堂本体，负责基础医疗、病人照看和教堂事务；旁边的田地由圣钟菜园承接 |
...
| 圣钟菜园 | `saint_bell_field_1` | 1号农田 | 圣钟菜园第 1 块农田 |
| 圣钟菜园 | `saint_bell_field_2` | 2号农田 | 圣钟菜园第 2 块农田 |
...
3. 圣钟教堂 / 圣钟菜园：教堂医护、老种子、菜田与草药照护职责。
