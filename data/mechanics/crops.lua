...
varieties = {
    ...
    mint = {
        ...
        stages = {"seed", "sprout", "vegetative", "flowering", "ripe"},
        maturation_hours = 48,
        harvest_returns_to_stage = "vegetative",
        max_harvests = 3,
        yield_decay_per_harvest = 0.85,
        harvest_yield_id = "mint_leaf",
        harvest_yield_quantity = 2,
        harvest_extra_yields = {},
        moisture_decay_per_hour = 0.55 / 24,
        optimal_moisture_min = 0.3,
        optimal_moisture_max = 0.85,
        stage_colors = {
            {0.30, 0.24, 0.18, 1},
            {0.45, 0.82, 0.42, 1},
            {0.25, 0.72, 0.36, 1},
        ...
        stage_scales = {0.28, 0.48, 0.72, 0.90, 1.0},
    },
    mugwort = {
        id = "mugwort",
        display_name = "艾草",
        ...
        harvest_returns_to_stage = "vegetative",
        max_harvests = 2,
        yield_decay_per_harvest = 0.9,
        harvest_yield_id = "mugwort_leaf",
        harvest_yield_quantity = 2,
        harvest_extra_yields = {},
        moisture_decay_per_hour = 0.4 / 24,
        optimal_moisture_min = 0.15,
        optimal_moisture_max = 0.7,
        stage_colors = {
            {0.34, 0.26, 0.18, 1},
            {0.48, 0.62, 0.36, 1},
            {0.44, 0.58, 0.34, 1},
        ...
        stage_scales = {0.30, 0.50, 0.78, 0.95, 1.05},
    },
    ginger = {
        id = "ginger",
        display_name = "姜",
        stages = {"seed", "sprout", "vegetative", "flowering", "ripe"},
        maturation_hours = 120,
        harvest_returns_to_stage = "",
        max_harvests = 1,
        yield_decay_per_harvest = 1.0,
        harvest_yield_id = "ginger_root",
        harvest_yield_quantity = 2,
        harvest_extra_yields = {},
        moisture_decay_per_hour = 0.6 / 24,
        ...
        stage_scales = {0.30, 0.50, 0.76, 0.95, 1.08},
    },
    plantain = {
        id = "plantain",
        display_name = "车前草",
        ...
        max_harvests = 2,
        yield_decay_per_harvest = 0.9,
        harvest_yield_id = "plantain_leaf",
        harvest_yield_quantity = 2,
        harvest_extra_yields = {},
        moisture_decay_per_hour = 0.5 / 24,
        optimal_moisture_min = 0.2,
        optimal_moisture_max = 0.85,
        stage_colors = {
            {0.32, 0.25, 0.17, 1},
        ...
        stage_scales = {0.28, 0.48, 0.72, 0.88, 1.0},
    },
    calendula = {
        id = "calendula",
        display_name = "金盏花",
        stages = {"seed", "sprout", "vegetative", "flowering", "ripe"},
        maturation_hours = 64,
        harvest_returns_to_stage = "flowering",
        max_harvests = 3,
        yield_decay_per_harvest = 0.85,
        harvest_yield_id = "calendula_flower",
        harvest_yield_quantity = 2,
        harvest_extra_yields = {},
        moisture_decay_per_hour = 0.5 / 24,
        optimal_moisture_min = 0.2,
        ...
        stage_scales = {0.30, 0.50, 0.78, 1.0, 1.08},
    },
    valerian = {
        id = "valerian",
        display_name = "缬草",
        ...
        max_harvests = 1,
        yield_decay_per_harvest = 1.0,
        harvest_yield_id = "valerian_root",
        harvest_yield_quantity = 2,
        harvest_extra_yields = {},
        moisture_decay_per_hour = 0.55 / 24,
        optimal_moisture_min = 0.35,
        ...
        stage_scales = {0.30, 0.50, 0.78, 0.96, 1.05},
    },
}
